...
| 2 | Identity / Context | Drug name, class, what it is, and why it's used. This is the anchor slide — a medic who has never heard of this drug should walk away from this slide knowing what it is and why it exists before the mechanism breakdown starts. Not brief filler — a real introduction. Use `[blue: ...]` for class terms and `[green: ...]` for indications. |
...
```
[1]  [amber: Dopamine] — the drug that changes what it does based on how much you give.
     *Same drug, three completely different receptor profiles...*

[2]  <sectionLabel>Overview</sectionLabel>
     It's a [blue: catecholamine] and [blue: sympathomimetic] — one of the few drugs where the dose changes which receptors you're hitting entirely.
...
```
[1]  [amber: Naloxone] — understand it, not just memorize it.
     *The whole drug makes sense once you see how the binding works...*

[2]  <sectionLabel>Overview</sectionLabel>
     It's a [blue: competitive opioid antagonist], used to reverse [green: opioid overdose].
     One mechanism. One target. Clean drug to understand.
     *Start with what opioids are doing in the first place...*

[3]  <sectionLabel>Mechanism</sectionLabel>
     Opioids bind [blue: mu receptors] in the brain and brainstem.
     That's what suppresses the [lavender: respiratory drive] — the mechanism behind the overdose.
...
[5]  <sectionLabel>Mechanism</sectionLabel>
     With the [blue: mu receptor] blocked and unactivated, the opioid effects reverse.
